...
public class AppColors: UIColor {
    ...
    public static var mainColorHex: String {
        didSet {
    ...
    public static var secondaryColorHex: String {
        didSet {
    ...
    public static var appMainThemeColor = AppColors.color(key: mainColorHex, else: #colorLiteral(red: 0, green: 0.8666666667, blue: 0.5254901961, alpha: 1))

    /// Secondary Theme Color. Default is #FF3154 (255, 49, 84) Red
    public static var appSecodaryThemeColor = AppColors.color(key: secondaryColorHex, else: #colorLiteral(red: 1, green: 0.2, blue: 0.3294117647, alpha: 1))

    /// Yerevan Ride icon's second part color. Default is #10495A
    public static let appYerevanRideSecondPartColor = #colorLiteral(red: 0.06274509804, green: 0.2862745098, blue: 0.3529411765, alpha: 1)

    /// Ameriabank green color. Default is #005164
    public static let ameriaGreen = #colorLiteral(red: 0, green: 0.3176470588, blue: 0.3921568627, alpha: 1)

    /// Mild Gray. #BABEC9 (189, 190, 201)
    public static let appMildGrayColor = #colorLiteral(red: 0.7294117647, green: 0.7450980392, blue: 0.7882352941, alpha: 1)

    /// Gray. #888AA1 (136, 138, 161)
    public static let appGrayColor = #colorLiteral(red: 0.5333333333, green: 0.5411764706, blue: 0.631372549, alpha: 1)

    /// Dark Gray. #4C556B (76, 85, 107)
    public static let appDarkGrayColor = #colorLiteral(red: 0.2980392157, green: 0.3333333333, blue: 0.4196078431, alpha: 1)

    /// Background Gray Color. #F4F7FC (244, 247, 252)
    public static let appBackgroundLightGrayColor = #colorLiteral(red: 0.9568627451, green: 0.968627451, blue: 0.9882352941, alpha: 1)
...
//    static let appMainBlackBlueColor = #colorLiteral(red: 0.2588235294, green: 0.3019607843, blue: 0.4039215686, alpha: 1)
    ...
    public static func color(key: String, sourceLocal: Bool) -> UIColor {
    ...
    public static func color(key: String, else defaultColor: UIColor) -> UIColor {
    ...
    private static func colorsSource(local: Bool) -> [String: String] {
